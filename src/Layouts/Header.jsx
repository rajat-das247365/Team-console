...
const Header = ({ toggle }) => {
  ...
  return (
    <div className="flex bg-[#161B22]  w-full">
      ...
      <div className="flex justify-between  md:px-10 items-center text-slate-200 w-full h-20 border-b border-slate-700">
        ...
        <div className=" flex items-center add bg-green-700 rounded-sm md:w-40 sm:w-20 h-10 justify-center hover:bg-green-500 font-bold">
          ...
          <button onClick={()=>setAddUser(true)} className="text-white ">
      ...
      {/*add user box */}
      {addUser&&(
                 <div className="text-slate-200 top-50 left-50 translate-x-60 -translate-y-20 editbox  backdrop-blur-xl sm:w-2xs  md:w-4xl rounded-lg border border-slate-700 absolute">
                <div className="boxheadwrap border border-b-slate-700 border-t-0 border-r-0 border-l-0 w-full p-5 flex items-center justify-around">
